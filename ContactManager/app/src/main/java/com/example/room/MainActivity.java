...
public class MainActivity extends AppCompatActivity {
  ...
  //Задаем макет активити
    // Привязываем переменные к элементу интерфейса
    @Override
...
//Получсем из бд все записи асинхронно
...
//Открываем активити добавления и ожидаем результат добавления
